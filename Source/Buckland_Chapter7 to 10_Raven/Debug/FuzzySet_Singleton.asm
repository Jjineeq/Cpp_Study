; Listing generated by Microsoft (R) Optimizing Compiler Version 19.33.31630.0 
	...
	TITLE	C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\Debug\FuzzySet_Singleton.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG46293 DB	'invalid argument', 00H
	ORG $+3
$SG46294 DB	'%s', 00H
	ORG $+1
$SG46295 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG46297 DB	00H, 00H
	ORG $+2
$SG46296 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG46298 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
; File C:\Users\user\github\Cpp_Study\Source\Common\fuzzy\FuzzySet_Singleton.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_val$ = 8						; size = 8
