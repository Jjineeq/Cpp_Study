; Listing generated by Microsoft (R) Optimizing Compiler Version 19.33.31630.0 
	...
	TITLE	C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\Debug\Raven_SensoryMemory.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG167047 DB	'< Raven_SensoryMemory::GetLastRecordedPositionOfOpponent'
	DB	'>: Attempting to get position of unrecorded bot', 00H
?piecewise_construct@std@@3Upiecewise_construct_t@1@B	ORG $+1 ; std::piecewise_construct
	ORG $+3
$SG176059 DB	'invalid argument', 00H
	ORG $+3
$SG176060 DB	'%s', 00H
	ORG $+1
$SG176063 DB	00H, 00H
	ORG $+2
$SG176061 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG176062 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG176064 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+6
$SG176954 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
$LN7@Allocate_m:
	push	OFFSET $SG176059
	push	OFFSET $SG176060
	push	0
	push	137					; 00000089H
	push	OFFSET $SG176061
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG176062
	push	OFFSET $SG176063
	push	OFFSET $SG176064
	call	__invalid_parameter
	add	esp, 20					; 00000014H
	xor	ecx, ecx
...
; 1305 :     iterator erase(iterator _Where) noexcept /* strengthened */ {
...
; 1306 :         const auto _Scary = _Get_scary();
...
; 1307 : #if _ITERATOR_DEBUG_LEVEL == 2
; 1308 :         _STL_VERIFY(_Where._Getcont() == _Scary, "map/set erase iterator from incorrect container");
...
; 1309 :         _STL_VERIFY(!_Where._Ptr->_Isnil, "cannot erase map/set end() iterator");
...
; 1310 : #endif // _ITERATOR_DEBUG_LEVEL == 2
; 1311 :         return iterator(_Erase_unchecked(_Where._Unwrapped()), _Scary);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Common\time\crudetimer.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\Raven_SensoryMemory.cpp
_TEXT	SEGMENT
tv192 = -124						; size = 4
tv190 = -120						; size = 4
$T2 = -116						; size = 12
...
; 1269 :     _Nodeptr _Erase_unchecked(_Unchecked_const_iterator _Where) noexcept {
...
; 1270 :         const auto _Scary                    = _Get_scary();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Get_scary@?$_Tree@V?$_Tmap_traits@PAVRaven_Bot@@VMemoryRecord@@U?$less@PAVRaven_Bot@@@std@@V?$allocator@U?$pair@QAVRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@IAEPAV?$_Tree_val@U?$_Tree_simple_types@U?$pair@QAVRaven_Bot@@VMemoryRecord@@@std@@@std@@@2@XZ ; std::_Tree<std::_Tmap_traits<Raven_Bot *,MemoryRecord,std::less<Raven_Bot *>,std::allocator<std::pair<Raven_Bot * const,MemoryRecord> >,0> >::_Get_scary
	mov	DWORD PTR __Scary$[ebp], eax

; 1271 :         _Unchecked_const_iterator _Successor = _Where;

	mov	eax, DWORD PTR __Where$[ebp]
	mov	DWORD PTR __Successor$[ebp], eax

; 1272 :         ++_Successor; // save successor iterator for return

	lea	ecx, DWORD PTR __Successor$[ebp]
	call	??E?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@QAVRaven_Bot@@VMemoryRecord@@@std@@@std@@@std@@U_Iterator_base0@2@@std@@QAEAAV01@XZ ; std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<Raven_Bot * const,MemoryRecord> > >,std::_Iterator_base0>::operator++

; 1273 :         _Nodeptr _Erasednode = _Scary->_Extract(_Where); // node to erase
...
; 1274 :         _Scary->_Orphan_ptr(_Erasednode);
...
; 1275 :         _Node::_Freenode(_Getal(), _Erasednode); // delete erased node
...
; 1276 :         return _Successor._Ptr; // return successor nodeptr
...
; 1127 :     _NODISCARD const_iterator begin() const noexcept {
...
; 1128 :         const auto _Scary = _Get_scary();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Get_scary@?$_Tree@V?$_Tmap_traits@PAVRaven_Bot@@VMemoryRecord@@U?$less@PAVRaven_Bot@@@std@@V?$allocator@U?$pair@QAVRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@IBEPBV?$_Tree_val@U?$_Tree_simple_types@U?$pair@QAVRaven_Bot@@VMemoryRecord@@@std@@@std@@@2@XZ ; std::_Tree<std::_Tmap_traits<Raven_Bot *,MemoryRecord,std::less<Raven_Bot *>,std::allocator<std::pair<Raven_Bot * const,MemoryRecord> >,0> >::_Get_scary
	mov	DWORD PTR __Scary$[ebp], eax

; 1129 :         return const_iterator(_Scary->_Myhead->_Left, _Scary);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\Raven_SensoryMemory.h
