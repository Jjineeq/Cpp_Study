...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG168160 DB	'invalid argument', 00H
	ORG $+3
$SG168161 DB	'%s', 00H
	ORG $+1
$SG168164 DB	00H, 00H
	ORG $+2
$SG168162 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+6
$SG168163 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG168165 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
PUBLIC	??_C@_0FP@JJEGPCOP@C?3?2Program?5Files?2Microsoft?5Visu@ ; `string'
PUBLIC	??_C@_1LO@BGMEDBLJ@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1LO@BGMEDBLJ@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe@
CONST	SEGMENT
??_C@_1LO@BGMEDBLJ@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe@ DB 'C'
...
CONST	ENDS
;	COMDAT ??_C@_0FP@JJEGPCOP@C?3?2Program?5Files?2Microsoft?5Visu@
CONST	SEGMENT
??_C@_0FP@JJEGPCOP@C?3?2Program?5Files?2Microsoft?5Visu@ DB 'C:\Program F'
	DB	'iles\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.'
	DB	'33.31629\include\list', 00H			; `string'
CONST	ENDS
...
$LN7@Allocate_m:
	push	OFFSET $SG168160
	push	OFFSET $SG168161
	push	0
	push	137					; 00000089H
	push	OFFSET $SG168162
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG168163
	push	OFFSET $SG168164
	push	OFFSET $SG168165
...
; 1836 : { return _Left._Get_current() != _Right._Get_current(); }
...
; 1808 :     _NODISCARD constexpr const _BidIt& _Get_current() const noexcept {
...
; 1719 :     _CONSTEXPR17 reverse_iterator& operator++() {
...
; 1689 :     _NODISCARD _CONSTEXPR17 reference operator*() const {
...
; 1661 :     _CONSTEXPR17 explicit reverse_iterator(_BidIt _Right) noexcept(
...
; 1662 :         is_nothrow_move_constructible_v<_BidIt>) // strengthened
; 1663 :         : current(_STD move(_Right)) {}
...
; 1659 :     _CONSTEXPR17 reverse_iterator() = default;
...
; 1666 :     template <class _Other>
; 1667 : #ifdef __cpp_lib_concepts
; 1668 :         requires (!is_same_v<_Other, _BidIt>) && convertible_to<const _Other&, _BidIt>
; 1669 : #endif // __cpp_lib_concepts
; 1670 :     _CONSTEXPR17 reverse_iterator(const reverse_iterator<_Other>& _Right) noexcept(
; 1671 :         is_nothrow_constructible_v<_BidIt, const _Other&>) // strengthened
; 1672 :         : current(_Right.current) {}
; 1673 : 
; 1674 :     template <class _Other>
; 1675 : #ifdef __cpp_lib_concepts
; 1676 :         requires (!is_same_v<_Other, _BidIt>) && convertible_to<const _Other&, _BidIt>
; 1677 :             && assignable_from<_BidIt&, const _Other&>
; 1678 : #endif // __cpp_lib_concepts
; 1679 :     _CONSTEXPR17 reverse_iterator& operator=(const reverse_iterator<_Other>& _Right) {
; 1680 :         current = _Right.current;
; 1681 :         return *this;
; 1682 :     }
; 1683 :     // clang-format on
; 1684 : 
; 1685 :     _NODISCARD _CONSTEXPR17 _BidIt base() const {
; 1686 :         return current;
; 1687 :     }
; 1688 : 
; 1689 :     _NODISCARD _CONSTEXPR17 reference operator*() const {
...
; 1692 :     }
; 1693 : 
; 1694 : #ifdef __cpp_lib_concepts
; 1695 :     // clang-format off
; 1696 :     _NODISCARD constexpr pointer operator->() const
; 1697 :         requires (is_pointer_v<_BidIt> || requires(const _BidIt __i) { __i.operator->(); }) {
; 1698 :         _BidIt _Tmp = current;
; 1699 :         --_Tmp;
; 1700 :         if constexpr (is_pointer_v<_BidIt>) {
; 1701 :             return _Tmp;
; 1702 :         } else {
; 1703 :             return _Tmp.operator->();
; 1704 :         }
; 1705 :     }
; 1706 :     // clang-format on
; 1707 : #else // ^^^ __cpp_lib_concepts / !__cpp_lib_concepts vvv
; 1708 :     _NODISCARD _CONSTEXPR17 pointer operator->() const {
; 1709 :         _BidIt _Tmp = current;
; 1710 :         --_Tmp;
; 1711 :         if constexpr (is_pointer_v<_BidIt>) {
; 1712 :             return _Tmp;
; 1713 :         } else {
; 1714 :             return _Tmp.operator->();
; 1715 :         }
; 1716 :     }
; 1717 : #endif // __cpp_lib_concepts
; 1718 : 
; 1719 :     _CONSTEXPR17 reverse_iterator& operator++() {
; 1720 :         --current;
; 1721 :         return *this;
; 1722 :     }
; 1723 : 
; 1724 :     _CONSTEXPR17 reverse_iterator operator++(int) {
; 1725 :         reverse_iterator _Tmp = *this;
; 1726 :         --current;
; 1727 :         return _Tmp;
; 1728 :     }
; 1729 : 
; 1730 :     _CONSTEXPR17 reverse_iterator& operator--() {
; 1731 :         ++current;
; 1732 :         return *this;
; 1733 :     }
; 1734 : 
; 1735 :     _CONSTEXPR17 reverse_iterator operator--(int) {
; 1736 :         reverse_iterator _Tmp = *this;
; 1737 :         ++current;
; 1738 :         return _Tmp;
; 1739 :     }
; 1740 : 
; 1741 :     _NODISCARD _CONSTEXPR17 reverse_iterator operator+(const difference_type _Off) const {
; 1742 :         return reverse_iterator(current - _Off);
; 1743 :     }
; 1744 : 
; 1745 :     _CONSTEXPR17 reverse_iterator& operator+=(const difference_type _Off) {
; 1746 :         current -= _Off;
; 1747 :         return *this;
; 1748 :     }
; 1749 : 
; 1750 :     _NODISCARD _CONSTEXPR17 reverse_iterator operator-(const difference_type _Off) const {
; 1751 :         return reverse_iterator(current + _Off);
; 1752 :     }
; 1753 : 
; 1754 :     _CONSTEXPR17 reverse_iterator& operator-=(const difference_type _Off) {
; 1755 :         current += _Off;
; 1756 :         return *this;
; 1757 :     }
; 1758 : 
; 1759 :     _NODISCARD _CONSTEXPR17 reference operator[](const difference_type _Off) const {
; 1760 :         return current[static_cast<difference_type>(-_Off - 1)];
; 1761 :     }
; 1762 : 
; 1763 : #ifdef __cpp_lib_concepts
; 1764 :     _NODISCARD_FRIEND constexpr iter_rvalue_reference_t<_BidIt> iter_move(const reverse_iterator& _It) noexcept(
; 1765 :         is_nothrow_copy_constructible_v<_BidIt>&& noexcept(_RANGES iter_move(--_STD declval<_BidIt&>()))) {
; 1766 :         auto _Tmp = _It.current;
; 1767 :         --_Tmp;
; 1768 :         return _RANGES iter_move(_Tmp);
; 1769 :     }
; 1770 : 
; 1771 :     template <indirectly_swappable<_BidIt> _BidIt2>
; 1772 :     friend constexpr void iter_swap(const reverse_iterator& _Left, const reverse_iterator<_BidIt2>& _Right) noexcept(
; 1773 :         is_nothrow_copy_constructible_v<_BidIt>&& is_nothrow_copy_constructible_v<_BidIt2>&& noexcept(
; 1774 :             _RANGES iter_swap(--_STD declval<_BidIt&>(), --_STD declval<_BidIt2&>()))) {
; 1775 :         auto _LTmp = _Left.current;
; 1776 :         auto _RTmp = _Right.base();
; 1777 :         --_LTmp;
; 1778 :         --_RTmp;
; 1779 :         _RANGES iter_swap(_LTmp, _RTmp);
; 1780 :     }
; 1781 : #endif // __cpp_lib_concepts
; 1782 : 
; 1783 :     using _Prevent_inheriting_unwrap = reverse_iterator;
; 1784 : 
; 1785 :     template <class _BidIt2, enable_if_t<_Range_verifiable_v<_BidIt, _BidIt2>, int> = 0>
; 1786 :     friend constexpr void _Verify_range(const reverse_iterator& _First, const reverse_iterator<_BidIt2>& _Last) {
; 1787 :         _Verify_range(_Last._Get_current(), _First.current); // note reversed parameters
; 1788 :     }
; 1789 : 
; 1790 :     template <class _BidIt2 = _BidIt, enable_if_t<_Offset_verifiable_v<_BidIt2>, int> = 0>
; 1791 :     constexpr void _Verify_offset(const difference_type _Off) const {
; 1792 :         _STL_VERIFY(_Off != _Min_possible_v<difference_type>, "integer overflow");
; 1793 :         current._Verify_offset(-_Off);
; 1794 :     }
; 1795 : 
; 1796 :     template <class _BidIt2 = _BidIt, enable_if_t<_Unwrappable_v<const _BidIt2&>, int> = 0>
; 1797 :     _NODISCARD constexpr reverse_iterator<_Unwrapped_t<const _BidIt2&>> _Unwrapped() const {
; 1798 :         return static_cast<reverse_iterator<_Unwrapped_t<const _BidIt2&>>>(current._Unwrapped());
; 1799 :     }
; 1800 : 
; 1801 :     static constexpr bool _Unwrap_when_unverified = _Do_unwrap_when_unverified_v<_BidIt>;
; 1802 : 
; 1803 :     template <class _Src, enable_if_t<_Wrapped_seekable_v<_BidIt, const _Src&>, int> = 0>
; 1804 :     constexpr void _Seek_to(const reverse_iterator<_Src>& _It) {
; 1805 :         current._Seek_to(_It.current);
; 1806 :     }
; 1807 : 
; 1808 :     _NODISCARD constexpr const _BidIt& _Get_current() const noexcept {
; 1809 :         return current;
...
$LN7@operator:
	...
	push	0
	push	195					; 000000c3H
	push	OFFSET ??_C@_0FP@JJEGPCOP@C?3?2Program?5Files?2Microsoft?5Visu@
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN11@operator:
	push	0
	push	195					; 000000c3H
	push	OFFSET ??_C@_1LO@BGMEDBLJ@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe@
