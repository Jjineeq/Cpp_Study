...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG168693 DB	'invalid argument', 00H
	ORG $+3
$SG168694 DB	'%s', 00H
	ORG $+1
$SG168697 DB	00H, 00H
	ORG $+2
$SG168695 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+6
$SG168696 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG168698 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG168693
	push	OFFSET $SG168694
	push	0
	push	135					; 00000087H
	push	OFFSET $SG168695
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG168696
	push	OFFSET $SG168697
	push	OFFSET $SG168698
