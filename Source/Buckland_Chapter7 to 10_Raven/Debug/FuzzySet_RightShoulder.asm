...
CONST	SEGMENT
$SG44876 DB	'invalid argument', 00H
	ORG $+3
$SG44877 DB	'%s', 00H
	ORG $+1
$SG44878 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+2
$SG44880 DB	00H, 00H
	ORG $+2
$SG44879 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG44881 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
