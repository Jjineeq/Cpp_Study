; Listing generated by Microsoft (R) Optimizing Compiler Version 19.33.31630.0 
	...
	TITLE	C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\Debug\GraveMarkers.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG164930 DB	'invalid argument', 00H
	ORG $+3
$SG164931 DB	'%s', 00H
	ORG $+1
$SG164932 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG164934 DB	00H, 00H
	ORG $+2
$SG164933 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG164935 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG164930
	push	OFFSET $SG164931
	push	0
	push	137					; 00000089H
	push	OFFSET $SG164932
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG164933
	push	OFFSET $SG164934
	push	OFFSET $SG164935
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Common\2D\Transformations.h
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Common\2D\C2DMatrix.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\GraveMarkers.cpp
_TEXT	SEGMENT
$T1 = -28						; size = 24
_this$ = -4						; size = 4
_pos$ = 8						; size = 16
...
; 776  :         _Choose_pocma_v<_Alty> != _Pocma_values::_No_propagate_allocators) {
...
; 777  :         if (this == _STD addressof(_Right)) {
...
; 779  :         }
; 780  : 
; 781  :         _Alty& _Al                = _Getal();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Getal@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@AAEAAV?$allocator@UVector2D@@@2@XZ ; std::vector<Vector2D,std::allocator<Vector2D> >::_Getal
	mov	DWORD PTR __Al$[ebp], eax

; 782  :         _Alty& _Right_al          = _Right._Getal();

	mov	ecx, DWORD PTR __Right$[ebp]
	call	?_Getal@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@AAEAAV?$allocator@UVector2D@@@2@XZ ; std::vector<Vector2D,std::allocator<Vector2D> >::_Getal
	mov	DWORD PTR __Right_al$[ebp], eax

; 783  :         constexpr auto _Pocma_val = _Choose_pocma_v<_Alty>;

	mov	DWORD PTR __Pocma_val$[ebp], 0

; 784  :         if constexpr (_Pocma_val == _Pocma_values::_No_propagate_allocators) {
; 785  :             if (_Al != _Right_al) {
; 786  :                 _Move_assign_unequal_alloc(_Right);
; 787  :                 return *this;
; 788  :             }
; 789  :         }
; 790  : 
...
; 793  :         if constexpr (_Pocma_val == _Pocma_values::_Propagate_allocators) {
; 794  :             if (_Al != _Right_al) {
; 795  :                 // intentionally slams into noexcept on OOM, TRANSITION, VSO-466800
; 796  :                 _Mypair._Myval2._Reload_proxy(_GET_PROXY_ALLOCATOR(_Alty, _Al), _GET_PROXY_ALLOCATOR(_Alty, _Right_al));
; 797  :             }
; 798  :         }
; 799  : #endif // _ITERATOR_DEBUG_LEVEL != 0
; 800  : 
; 801  :         _Pocma(_Al, _Right_al);
...
; 802  :         _Mypair._Myval2._Take_contents(_Right._Mypair._Myval2);
...
; 723  :         : _Mypair(_One_then_variadic_args_t{}, _Alty_traits::select_on_container_copy_construction(_Right._Getal())) {
...
; 724  :         const auto& _Right_data = _Right._Mypair._Myval2;

	mov	edx, DWORD PTR __Right$[ebp]
	mov	DWORD PTR __Right_data$[ebp], edx

; 725  :         const auto _Count       = static_cast<size_type>(_Right_data._Mylast - _Right_data._Myfirst);
...
; 726  :         _Construct_n(_Count, _Right_data._Myfirst, _Right_data._Mylast);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\GraveMarkers.h
