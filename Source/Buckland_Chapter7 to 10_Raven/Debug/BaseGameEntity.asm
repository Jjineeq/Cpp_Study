; Listing generated by Microsoft (R) Optimizing Compiler Version 19.33.31630.0 
	...
	TITLE	C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven\Debug\BaseGameEntity.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG158233 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
$SG162661 DB	'invalid argument', 00H
	ORG $+3
$SG158234 DB	'C', 00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H
...
$SG162662 DB	'%s', 00H
	ORG $+1
$SG158235 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
$SG162665 DB	00H, 00H
	ORG $+2
$SG162663 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+6
$SG162664 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG162666 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Common\Game\BaseGameEntity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG158233
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG158234
	push	OFFSET $SG158235
	call	__wassert
