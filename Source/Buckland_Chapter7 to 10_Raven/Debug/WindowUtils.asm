...
CONST	SEGMENT
$SG157107 DB	'Error', 00H
	ORG $+2
$SG157111 DB	'Error', 00H
	ORG $+2
$SG157210 DB	'*.*', 00H
$SG157211 DB	'All Files (*.*)', 00H
$SG157212 DB	'*.', 00H
	ORG $+1
$SG162079 DB	'invalid argument', 00H
	ORG $+3
$SG162080 DB	'%s', 00H
	ORG $+1
$SG162081 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG162083 DB	00H, 00H
	ORG $+2
$SG162082 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG162084 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG162079
	push	OFFSET $SG162080
	push	0
	push	137					; 00000089H
	push	OFFSET $SG162081
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG162082
	push	OFFSET $SG162083
	push	OFFSET $SG162084
...
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.33.31629\include\iomanip
...
; 5033 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, const basic_string<_Elem, _Traits, _Alloc>& _Right) {
...
; 5034 :     return _STD move(_Left.append(_Right));
...
; 5064 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, _In_z_ const _Elem* const _Right) {
...
; 5065 :     return _STD move(_Left.append(_Right));
...
; 5070 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, const _Elem _Right) {
...
; 5016 :     const basic_string<_Elem, _Traits, _Alloc>& _Left, const _Elem _Right) {
...
; 5017 :     const auto _Left_size = _Left.size();

	mov	ecx, DWORD PTR __Left$[ebp]
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	mov	DWORD PTR __Left_size$[ebp], eax

; 5018 :     if (_Left_size == _Left.max_size()) {
...
; 5020 :     }
; 5021 : 
; 5022 :     return {_String_constructor_concat_tag{}, _Left, _Left.c_str(), _Left_size, _STD addressof(_Right), 1};
...
$LN4@operator:
	push	71					; 00000047H
	push	OFFSET ??_C@_0GC@MNELFEFK@C?3?2Program?5Files?2Microsoft?5Visu@
	push	2
...
; 108  :   std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
	...
	push	0
	push	0
	push	OFFSET $SG157210
	push	0
	push	OFFSET $SG157211
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG157212
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
...
; 4042 :     _NODISCARD _CONSTEXPR20 reference at(const size_type _Off) {
...
; 4043 :         _Mypair._Myval2._Check_offset_exclusive(_Off);
...
; 4044 :         return _Mypair._Myval2._Myptr()[_Off];
