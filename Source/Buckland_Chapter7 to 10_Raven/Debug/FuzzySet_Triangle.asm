...
CONST	SEGMENT
$SG44871 DB	'invalid argument', 00H
	ORG $+3
$SG44872 DB	'%s', 00H
	ORG $+1
$SG44873 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+2
$SG44875 DB	00H, 00H
	ORG $+2
$SG44874 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG44876 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
