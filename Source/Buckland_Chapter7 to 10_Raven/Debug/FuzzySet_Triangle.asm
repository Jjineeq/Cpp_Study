...
CONST	SEGMENT
$SG46300 DB	'invalid argument', 00H
	ORG $+3
$SG46301 DB	'%s', 00H
	ORG $+1
$SG46302 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG46304 DB	00H, 00H
	ORG $+2
$SG46303 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG46305 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
