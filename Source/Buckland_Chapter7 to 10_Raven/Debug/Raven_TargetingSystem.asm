...
CONST	SEGMENT
$SG168141 DB	'invalid argument', 00H
	ORG $+3
$SG168142 DB	'%s', 00H
	ORG $+1
$SG168143 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG168145 DB	00H, 00H
	ORG $+2
$SG168144 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG168146 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG168141
	push	OFFSET $SG168142
	push	0
	push	137					; 00000089H
	push	OFFSET $SG168143
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG168144
	push	OFFSET $SG168145
	push	OFFSET $SG168146
