; Listing generated by Microsoft (R) Optimizing Compiler Version 19.34.31933.0 
	...
	TITLE	C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven_task\Debug\Raven_TargetingSystem.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG166496 DB	'invalid argument', 00H
	ORG $+3
$SG166497 DB	'%s', 00H
	ORG $+1
$SG166498 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+2
$SG166500 DB	00H, 00H
	ORG $+2
$SG166499 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG166501 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG166496
	push	OFFSET $SG166497
	push	0
	push	135					; 00000087H
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG166499
	push	OFFSET $SG166500
	push	OFFSET $SG166501
...
; 927  : _CONSTEXPR20 void _Pocma(_Alloc& _Left, _Alloc& _Right) noexcept { // (maybe) propagate on container move assignment

	push	ebp
	mov	ebp, esp

; 928  :     if constexpr (allocator_traits<_Alloc>::propagate_on_container_move_assignment::value) {
; 929  :         _Left = _STD move(_Right);
...
; 957  :     void _Swap_val(list& _Right) noexcept { // swap with _Right, same allocator
...
; 958  :         auto& _My_data    = _Mypair._Myval2;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR __My_data$[ebp], eax

; 959  :         auto& _Right_data = _Right._Mypair._Myval2;

	mov	ecx, DWORD PTR __Right$[ebp]
	mov	DWORD PTR __Right_data$[ebp], ecx

; 960  :         _My_data._Swap_proxy_and_iterators(_Right_data);
...
; 961  :         _Swap_adl(_My_data._Myhead, _Right_data._Myhead);
...
; 962  :         _STD swap(_My_data._Mysize, _Right_data._Mysize);
...
; 916  :         _Choose_pocma_v<_Alnode> == _Pocma_values::_Equal_allocators) /* strengthened */ {
...
; 917  :         if (this == _STD addressof(_Right)) {
...
; 922  :         auto& _Right_al           = _Right._Getal();

	mov	ecx, DWORD PTR __Right$[ebp]
	call	?_Getal@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@AAEAAV?$allocator@U?$_List_node@PAVRaven_Bot@@PAX@std@@@2@XZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::_Getal
	mov	DWORD PTR __Right_al$[ebp], eax

; 923  :         constexpr auto _Pocma_val = _Choose_pocma_v<_Alnode>;

	mov	DWORD PTR __Pocma_val$[ebp], 0

; 924  :         if constexpr (_Pocma_val == _Pocma_values::_Propagate_allocators) {
; 925  :             if (_Al != _Right_al) {
; 926  :                 auto&& _Alproxy       = _GET_PROXY_ALLOCATOR(_Alnode, _Al);
; 927  :                 auto&& _Right_alproxy = _GET_PROXY_ALLOCATOR(_Alnode, _Right_al);
; 928  :                 _Container_proxy_ptr<_Alty> _Proxy(_Right_alproxy, _Leave_proxy_unbound{});
; 929  :                 auto& _My_data      = _Mypair._Myval2;
; 930  :                 auto& _Right_data   = _Right._Mypair._Myval2;
; 931  :                 const auto _Newhead = _STD exchange(_Right_data._Myhead, _Node::_Buyheadnode(_Right_al));
; 932  :                 const auto _Newsize = _STD exchange(_Right_data._Mysize, size_type{0});
; 933  :                 _Tidy();
; 934  :                 _Pocma(_Al, _Right_al);
; 935  :                 _My_data._Myhead = _Newhead;
; 936  :                 _My_data._Mysize = _Newsize;
; 937  :                 _Proxy._Bind(_Alproxy, _STD addressof(_My_data));
; 938  :                 _My_data._Swap_proxy_and_iterators(_Right_data);
; 939  :                 return *this;
; 940  :             }
; 941  :         } else if constexpr (_Pocma_val == _Pocma_values::_No_propagate_allocators) {
; 942  :             if (_Al != _Right_al) {
; 943  :                 assign(_STD make_move_iterator(_Right._Unchecked_begin()),
; 944  :                     _STD make_move_iterator(_Right._Unchecked_end()));
; 945  :                 return *this;
; 946  :             }
; 947  :         }
; 948  : 
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven_task\Raven_TargetingSystem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
