; Listing generated by Microsoft (R) Optimizing Compiler Version 19.34.31933.0 
	...
	TITLE	C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven_task\Debug\main.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1JA@JNMNDMCH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@ ; `string'
PUBLIC	??_C@_1JA@JKGMJBNB@?$AAm?$AA_?$AAN?$AAo?$AAr?$AAm?$AAa?$AAl?$AAF?$AAP?$AAS?$AA?5?$AA?$CG?$AA?$CG?$AA?5@ ; `string'
PUBLIC	??_C@_1HM@PJMDIHKC@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@ ; `string'
...
??_C@_1BM@MMNOPHKK@?$AAm?$AA_?$AAh?$AAd?$AAc?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AAN?$AAU?$AAL?$AAL@ DB 'm'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1HM@PJMDIHKC@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@
CONST	SEGMENT
??_C@_1HM@PJMDIHKC@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@ DB 'C'
...
CONST	ENDS
;	COMDAT ??_C@_1JA@JNMNDMCH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@
CONST	SEGMENT
??_C@_1JA@JNMNDMCH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H, 'r', 00H
	DB	's', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H, 'r', 00H, '\'
	DB	00H, 'g', 00H, 'i', 00H, 't', 00H, 'h', 00H, 'u', 00H, 'b', 00H
	DB	'\', 00H, 'C', 00H, 'p', 00H, 'p', 00H, '_', 00H, 'S', 00H, 't'
	...
	DB	'u', 00H, 'r', 00H, 'c', 00H, 'e', 00H, '\', 00H, 'C', 00H, 'o'
	DB	00H, 'm', 00H, 'm', 00H, 'o', 00H, 'n', 00H, '_', 00H, 't', 00H
	DB	'a', 00H, 's', 00H, 'k', 00H, '\', 00H, 'T', 00H, 'i', 00H, 'm'
...
; 593  :     _In_reads_(_Right_size) const _Traits_ptr_t<_Traits> _Right, const size_t _Right_size) noexcept {
...
; 594  :     // compare [_Left, _Left + _Left_size) to [_Right, _Right + _Right_size) for equality using _Traits
...
; 5191 :     const basic_string<_Elem, _Traits, _Alloc>& _Left, _In_z_ const _Elem* const _Right) {

	push	ebp
	mov	ebp, esp

; 5192 :     return _Left._Equal(_Right);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Common_task\debug\DebugConsole.h
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven_task\main.cpp
_TEXT	SEGMENT
tv410 = -276						; size = 4
tv397 = -272						; size = 4
tv384 = -268						; size = 4
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Buckland_Chapter7 to 10_Raven_task\Raven_Game.h
...
; 2001 :     _NODISCARD _CONSTEXPR20 _Ty& back() noexcept /* strengthened */ {
...
; 195  :     assert(hdc != NULL);
	...
	push	195					; 000000c3H
	push	OFFSET ??_C@_1HM@PJMDIHKC@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Common_task\misc\windowutils.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\user\github\Cpp_Study\Source\Common_task\Time\PrecisionTimer.h
...
$LN4@ReadyForNe:
	push	90					; 0000005aH
	push	OFFSET ??_C@_1JA@JNMNDMCH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAu?$AAs?$AAe?$AAr?$AA?2?$AAg@
...
; 4754 :     _CONSTEXPR20 bool _Equal(_In_z_ const _Elem* const _Ptr) const noexcept {
...
; 4755 :         // compare [0, size()) with _Ptr for equality
...
; 3371 :     _CONSTEXPR20 basic_string& operator+=(const basic_string& _Right) {
...
; 378  : #if _HAS_CXX17
; 379  : #if _HAS_CXX20 && defined(__EDG__) // TRANSITION, VSO-1601168
; 380  :         if (_STD is_constant_evaluated()) {
; 381  :             for (size_t _Idx = 0; _Idx != _Count; ++_Idx) {
; 382  :                 if (static_cast<unsigned char>(_First1[_Idx]) < static_cast<unsigned char>(_First2[_Idx])) {
; 383  :                     return -1;
; 384  :                 }
; 385  : 
; 386  :                 if (static_cast<unsigned char>(_First2[_Idx]) < static_cast<unsigned char>(_First1[_Idx])) {
; 387  :                     return 1;
; 388  :                 }
; 389  :             }
; 390  :             return 0;
...
; 393  :         }
; 394  : #else // ^^^ workaround for EDG / no workaround needed for MSVC and Clang vvv
; 395  :         return __builtin_memcmp(_First1, _First2, _Count);
; 396  : #endif // ^^^ no workaround needed for MSVC and Clang ^^^
; 397  : #else // _HAS_CXX17
